...
analyze -library WORK -format verilog ../RTL/fm_step1.v
elaborate -architecture verilog -library WORK fm_step1

analyze -library WORK -format verilog ../RTL/fm_step2.v
elaborate -architecture verilog -library WORK fm_step2

analyze -library WORK -format verilog ../RTL/fm_step3.v
elaborate -architecture verilog -library WORK fm_step3

analyze -library WORK -format verilog ../RTL/fm_step4.v
elaborate -architecture verilog -library WORK fm_step4

analyze -library WORK -format verilog ../RTL/fa_step1.v
elaborate -architecture verilog -library WORK fa_step1

analyze -library WORK -format verilog ../RTL/fa_step2.v
elaborate -architecture verilog -library WORK fa_step2

analyze -library WORK -format verilog ../RTL/fa_step3.v
elaborate -architecture verilog -library WORK fa_step3

analyze -library WORK -format verilog ../RTL/fa_step4.v
elaborate -architecture verilog -library WORK fa_step4

analyze -library WORK -format verilog ../RTL/fa_step5.v
elaborate -architecture verilog -library WORK fa_step5
